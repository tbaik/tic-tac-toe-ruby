...
class TTTUI
  ...
  def determine_language
    language_input = receive_input_with_checker_and_invalid_response(ASK_LANGUAGE, :valid_language_input?, @text[:invalid_input])
  ...
  def receive_board_size
    receive_input_with_checker_and_invalid_response(@text[:ask_board_size], :valid_board_size?, @text[:invalid_input])
  end
  ...
  def receive_read_or_new_game
    receive_input_with_checker_and_invalid_response(@text[:ask_read_or_new_game], :valid_read_or_new_game_input?, @text[:invalid_input])
  end
